...
import EmployeeSearch.core.AuditHistory;
import EmployeeSearch.core.Employee;
import EmployeeSearch.core.User;
...
public class EmployeeDAO {
	 ...
	 public EmployeeDAO() throws Exception {
	  ...
	  props.load(new FileInputStream("demos.properties"));
	 ...
	 public List < AuditHistory > getAuditHistory(int employeeId) throws Exception {
	  ...
	  try {
	   ...
	   String sql = "SELECT history.user_id, history.employee_id, history.action, history.action_date_time, users.first_name, users.last_name  " + "FROM audit_history history, users users " + "WHERE history.user_id=users.id AND history.employee_id=" + employeeId;
	   ...
	   while (myRs.next()) {
	    ...
	    java.sql.Timestamp timestamp = myRs.getTimestamp("history.action_date_time");
